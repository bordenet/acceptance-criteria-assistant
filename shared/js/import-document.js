 ...
 * Handles importing existing Acceptance Criteria from Word/Google Docs via paste
 */
...
const DOC_TYPE = 'Acceptance Criteria';
const DOC_TYPE_SHORT = 'Issue AC';
...
export function showImportModal() {
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      const title = titleMatch ? titleMatch[1].replace(/^Issue:\s*/i, '').trim() : `Imported ${DOC_TYPE_SHORT}`;
