...
The validator scores acceptance criteria on a **100-point scale** across four dimensions:
...
Testability uses a deduction-based approach, penalizing vague language and anti-patterns. For complete methodology details including detection patterns, adversarial robustness, and calibration notes, see **[docs/Scoring_Methods.md](./docs/Scoring_Methods.md)**.
